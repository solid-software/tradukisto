...
class GenderForms {
   ...
   static GenderForms genderForms(String masculineForm, String feminineForm, String neuterForm) {
    return GenderForms(masculineForm, feminineForm, neuterForm);
  }

   static GenderForms genderFormsWithNa(String masculineForm, String feminineForm, String neuterForm, String nonApplicableForm) {
    return GenderForms.withNA(masculineForm, feminineForm, neuterForm, nonApplicableForm);
  }
   ...
   GenderForms.withNA(String masculineForm, String feminineForm, String neuterForm, String nonApplicableForm): _forms= {
     GenderType.MASCULINE: masculineForm,
     GenderType.FEMININE: feminineForm,
     GenderType.NEUTER: neuterForm,
   ...
   GenderForms.naForm(String nonApplicableForm) : _forms = {
